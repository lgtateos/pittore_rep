...
#include <tcl.h>
// commented out by Brent Dennis 07/23/03
// for some unknown reason USE_LOCAL_TK_H should never be defined but seems to be by something
// causing the definition of an incorrect TK_MAJORVERSION
/*
...
#endif
*/
// added to account for above changes
#include <tk.h>
...
int Togl_Init(Tcl_Interp *interp)
{
   ...
   if (major >=8 && minor >= 4) {
     //SetClassProcsPtr = tkStubsPtr->tk_SetClassProcs;		
	   // code change by Brent Dennis to acct for upgraded Tcl
